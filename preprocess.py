...
gyeonggi_map.save("gyeonggi_map.html")
chungbuk_map.save("chungbuk_map.html")
chungnam_map.save("chungnam_map.html")
jeonbuk_map.save("jeonbuk_map.html")
jeonnam_map.save("jeonnam_map.html")
gyeongbuk_map.save("gyeongbuk_map.html")
gyeongnam_map.save("gyeongnam_map.html")
jeju_map.save("jeju_map.html")
sejong_map.save("sejong_map.html")
gangwon_map.save("gangwon_map.html")
busan_map.save("busan_map.html")
ulsan_map.save("ulsan_map.html")
daejeon_map.save("daejeon_map.html")
gwangju_map.save("gwangju_map.html")
incheon_map.save("incheon_map.html")
